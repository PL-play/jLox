...
public class InterpreterTest {
    ...
    public void test28() throws IOException, URISyntaxException {
        byte[] bytes = Files.readAllBytes(Paths.get(getClass().getResource("test10.lox").toURI()));
        Lox.run(new String(bytes, Charset.defaultCharset()));
    }

    @Test
    public void test29() throws IOException, URISyntaxException {
        byte[] bytes = Files.readAllBytes(Paths.get(getClass().getResource("test11.lox").toURI()));
        Lox.run(new String(bytes, Charset.defaultCharset()));
    }

    @Test
    public void test30() throws IOException, URISyntaxException {
        byte[] bytes = Files.readAllBytes(Paths.get(getClass().getResource("test12.lox").toURI()));
        Lox.run(new String(bytes, Charset.defaultCharset()));
    }

    @Test
    public void test31() throws IOException, URISyntaxException {
        byte[] bytes = Files.readAllBytes(Paths.get(getClass().getResource("test13.lox").toURI()));
        Lox.run(new String(bytes, Charset.defaultCharset()));
    }

    @Test
    public void test32() throws IOException, URISyntaxException {
        byte[] bytes = Files.readAllBytes(Paths.get(getClass().getResource("test14.lox").toURI()));
        Lox.run(new String(bytes, Charset.defaultCharset()));
    }

    @Test
    public void test33() throws IOException, URISyntaxException {
        byte[] bytes = Files.readAllBytes(Paths.get(getClass().getResource("test15.lox").toURI()));
        Lox.run(new String(bytes, Charset.defaultCharset()));
    }
}
